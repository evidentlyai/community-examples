| Lesson | Part | Description | Notebook | Video |
|----------|------|-------------|----------|--------|
...
| **Tutorial: LLM Evaluation Methods** | Part 2 | Reference-based evaluation: exact match, semantic similarity, BERTScore, and LLM judge. | [Notebook](LLMCourse_Tutorial_1_Intro_to_LLM_evals_methods.ipynb) | [Video](https://youtu.be/JjvBaaNOnfA) |
